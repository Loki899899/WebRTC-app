...
const localVideoComponent = $('#local-video')
...
async function setLocalStream(mediaConstraints) {
    ...
    localStream = stream
    localVideoComponent.attr('src', stream)
}
...
function setRemoteStream(event) {
    remoteVideoComponent.attr('src', event.streams[0])
...
socket.on('leave', () => {
    ...
    remoteVideoComponent.toggleClass('disp-none');
    localVideoComponent.toggleClass('only-local-vid');
