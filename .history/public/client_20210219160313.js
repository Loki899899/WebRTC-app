...
const videoChatContainer = document.getElementById('chat-room')
const localVideoComponent = document.getElementId('local-video')
...
socket.on('leave', () => {
    ...
    remoteVideoComponent.toggleClass('no-remote-vid');
